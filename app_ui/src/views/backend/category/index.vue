<script setup >
  ...
  const handleBatchDel = async () => {
    ...
    await request.delete(`/category/batch/${ids}`)
    ElMessage({
      showClose: true,
      message: '批量删除成功',
      type: 'success'
  ...
  const beforeBatchUpload = async (file) => {
    let fd = new FormData()
    fd.append('file', file)
    await request.post('/category/batch/upload', fd, {
      headers: {
...
<template>
  ...
  <el-row class="page">
        ...
        <el-row>
          <el-col>
                        ...
                        <el-form-item label-width="5px">
                          <el-input v-model="name" placeholder="输入分类名称 "/>
                        </el-form-item>
    ...
    <el-col class="page-operate--layout">
      ...
      <!--   批量导入   -->
      <div v-permission="'sys:category:batch:upload'">
      ...
      <!--   批量删除   -->
      <div v-permission="'sys:category:batch:delete'">
        <el-popconfirm
      ...
      <div v-permission="'sys:category:batch:export'">
        <el-button
            type="warning"
            :icon="Download"
            :disabled="disabled"
    ...
    >
      ...
      >
        <el-table-column type="selection" width="55"/>
                ...
                <el-table-column prop="img" label="分类图标" align="center">
        ...
        <el-table-column label="操作" align="center" width="240">
          <template #default="scope">
            <div class="page-table-editout--layout">
              ...
              <div v-permission="'sys:category:delete'">
                <el-popconfirm
                    confirm-button-text="确定"
                    cancel-button-text="取消"
                    :icon="InfoFilled"
