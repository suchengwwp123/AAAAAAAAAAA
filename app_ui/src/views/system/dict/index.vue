...
<template>
  ...
  >
        ...
        <el-row>
          <el-col>
            ...
            <el-form-item label-width="5px">
              <el-input v-model="name" placeholder="输入字典名称"/>
            </el-form-item>


            <el-form-item label-width="5px">
              <el-input v-model="identification" placeholder="输入唯一标识"/>
            </el-form-item>
    ...
    <el-col class="page-operate--layout">
      <!--   新增   -->
      <div v-permission="'sys:dict:add'">
        <el-button type="primary" :icon="Plus" @click="handleAdd" size="small" plain
        >新增
        </el-button>
      </div>
      <!--   批量删除   -->
      <div v-permission="'sys:dict:batch:delete'">
        <el-popconfirm
      ...
      <div v-permission="'sys:dict:batch:export'">
        <el-button
            type="warning"
            :icon="Download"
            :disabled="disabled"
    ...
    <el-col>
      ...
      >
        ...
        <el-table-column prop="identification" label="唯一标识" show-overflow-tooltip>
          <template
              #default="scope"
          >
            <el-link
        ...
        <el-table-column prop="des" label="字典描述" show-overflow-tooltip/>
        ...
        <el-table-column label="操作" align="center">
          <template #default="scope">
            <div class="page-table-editout--layout">
              ...
              <div v-permission="'sys:dict:delete'">
                <el-popconfirm
                    confirm-button-text="确定"
                    cancel-button-text="取消"
                    :icon="InfoFilled"
