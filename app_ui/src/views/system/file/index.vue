<script setup >
import { ref } from 'vue'
import { Delete, Download, InfoFilled, Plus, Refresh, Search } from '@element-plus/icons-vue'
...
<template>
  <el-row class="page">
    ...
    <el-col class="page-operate--layout">
      <div v-permission="'sys:file:upload'">
      ...
      <div v-permission="'sys:file:batch:delete'">
        <el-popconfirm
    ...
    <el-col>
      ...
      >
        ...
        <el-table-column prop="name" label="文件名称" align="center" show-overflow-tooltip />
        <el-table-column prop="type" label="文件类型" align="center" />
        <el-table-column prop="size" label="文件大小(kb)" align="center" />
        <el-table-column prop="md5" label="md5" align="center" show-overflow-tooltip> </el-table-column>
        <el-table-column label="操作" align="center">
          <template #default="scope">
            <div class="page-table-editout--layout">
             <div  v-permission="'sys:file:download'">
               <el-button type="primary" :icon="Download" size="small" @click="download(scope.row.url)"
               >下载</el-button
               >
             </div>
              <div v-permission="'sys:file:delete'">
                <el-popconfirm
                  confirm-button-text="确定"
                  cancel-button-text="取消"
                  :icon="InfoFilled"
