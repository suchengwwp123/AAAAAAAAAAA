...
import RoleForm from '@/views/system/role/form/index.vue'
...
<template>
  ...
  <el-row class="page">
    ...
    <el-col class="page-operate--layout">
      ...
      <div v-permission="'sys:role:batch:export'">
        <el-button
            type="warning"
            :icon="Download"
            :disabled="disabled"
    ...
    <el-col>
      ...
      >
        ...
        <el-table-column type="index" label="序号" align="center" sortable width="70"/>
        <el-table-column prop="name" label="角色名称" align="center" show-overflow-tooltip/>
        <el-table-column prop="description" label="描述" align="center" show-overflow-tooltip/>
        <el-table-column prop="perms" label="唯一标识" align="center" show-overflow-tooltip/>
