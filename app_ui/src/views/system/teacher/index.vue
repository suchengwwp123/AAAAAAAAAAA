<script setup >
import { ref } from 'vue'
import { Delete, Download, Edit, InfoFilled, Plus, Refresh, Search, View } from '@element-plus/icons-vue'
import request from '@/utils/request'
import { ElMessage } from 'element-plus'
import UserForm from '@/views/system/teacher/form/index.vue'
...
// 分页查询
const load = async () => {
  const res = await request.get('/user/pages', {
    params: {
      name: name.value,
