  ...
  <el-row class="page">
    ...
    <el-col>
      ...
      >
        ...
        <el-table-column prop="params" label="参数" align="center" show-overflow-tooltip/>
<!--        <el-table-column prop="broswer" label="浏览器" align="center" show-overflow-tooltip/>-->
